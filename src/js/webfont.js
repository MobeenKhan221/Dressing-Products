...
/* Web Font Loader v1.6.26 - (c) Adobe Systems, Google. License: Apache 2.0 */ (function () {
  ...
  function y(a, b) {
    for (let c = a.className.split(/\s+/), d = 0, e = c.length; d < e; d++)
      if (c[d] == b) return !0;
    return !1;
  }
  function z(a) {
  ...
  Q.prototype.start = function () {
    ...
    const b = this;
    const c = q();
    const d = new Promise(function (d, e) {
      function k() {
        q() - c >= b.f
          ? e()
          : a.fonts.load(fa(b.a), b.h).then(
              function (a) {
                a.length >= 1 ? d() : setTimeout(k, 25);
              },
              function () {
                e();
              },
    ...
    const e = new Promise(function (a, d) {
      setTimeout(d, b.f);
    });
  ...
  function U() {
    if (T === null) {
      ...
      T =
        !!a &&
        (parseInt(a[1], 10) < 536 || (parseInt(a[1], 10) === 536 && parseInt(a[2], 10) <= 11));
    }
    return T;
  }
  ...
  function ma(a, b, c) {
    for (const d in S) if (S.hasOwnProperty(d) && b === a.f[S[d]] && c === a.f[S[d]]) return !0;
    return !1;
  }
  function la(a) {
    ...
    d
      ? q() - a.A >= a.w
        ? U() && ma(a, b, c) && (a.u === null || a.u.hasOwnProperty(a.a.c))
          ? V(a, a.v)
          : V(a, a.B)
        : na(a)
      : V(a, a.v);
  ...
  W.prototype.h = function (a) {
    const b = this.a;
    if (b.g) {
      const c = y(b.f, b.a.c('wf', a.c, K(a).toString(), 'active'));
      const d = [];
  ...
  sa.prototype.load = function (a) {
    function b() {
      if (f[`__mti_fntLst${d}`]) {
        const c = f[`__mti_fntLst${d}`]();
        const e = [];
        let h;
        if (c)
          for (let m = 0; m < c.length; m++) {
            const l = c[m].fontfamily;
  ...
  ua.prototype.load = function (a) {
    ...
    for (c = e.length; b < c; b++)
      if (((d = e[b].split(':')), d[1]))
        for (let h = d[1].split(','), m = 0; m < h.length; m += 1) k.push(new H(d[0], h[m]));
    ...
    b
      ? (c.__webfontfontdeckmodule__ || (c.__webfontfontdeckmodule__ = {}),
        (c.__webfontfontdeckmodule__[b] = function (b, c) {
          for (let g = 0, k = c.fonts.length; g < k; ++g) {
            const h = c.fonts[g];
