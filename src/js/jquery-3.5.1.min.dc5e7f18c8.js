...
!(function (e, t) {
  ...
  function p(e) {
    ...
    const n = w(e);
    return (
      !m(e) && !x(e) && (n === 'array' || t === 0 || (typeof t === 'number' && t > 0 && t - 1 in e))
    );
  }
  (S.fn = S.prototype =
    {
    ...
    S.extend({
      ...
      isPlainObject(e) {
        ...
        return (
          ...
          (!(t = r(e)) ||
            (typeof (n = v.call(t, 'constructor') && t.constructor) === 'function' &&
              a.call(n) === l))
        );
      },
      isEmptyObject(e) {
      ...
      makeArray(e, t) {
        const n = t || [];
        return (
          e != null && (p(Object(e)) ? S.merge(n, typeof e === 'string' ? [e] : e) : u.call(n, e)),
          n
        );
      },
      inArray(e, t, n) {
      ...
      map(e, t, n) {
        ...
        let o = 0;
        const a = [];
        if (p(e)) for (r = e.length; o < r; o++) (i = t(e[o], o, n)) != null && a.push(i);
  ...
  const d = (function (n) {
    ...
    function se(t, e, n, r) {
      ...
      if (((n = n || []), typeof t !== 'string' || !t || (p !== 1 && p !== 9 && p !== 11)))
        return n;
      if (!r && (T(e), (e = e || C), E)) {
        if (p !== 11 && (u = Z.exec(t)))
          if ((i = u[1])) {
          ...
          r != C &&
            ...
            d.getById
              ...
              : ((b.filter.ID = function (e) {
                  ...
                  return function (e) {
                    const t = typeof e.getAttributeNode !== 'undefined' && e.getAttributeNode('id');
                    return t && t.value === n;
                  };
                }),
                (b.find.ID = function (e, t) {
  ...
  (S.filter = function (e, t, n) {
    ...
    S.fn.extend({
      ...
      is(e) {
        return !!D(this, typeof e === 'string' && k.test(e) ? S(e) : e || [], !1).length;
      },
    });
  let j;
  const q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
      ...
      if (!k.test(e))
        for (; r < i; r++)
          for (n = this[r]; n && n !== t; n = n.parentNode)
            if (
              n.nodeType < 11 &&
              (a ? a.index(n) > -1 : n.nodeType === 1 && S.find.matchesSelector(n, e))
            ) {
              o.push(n);
              break;
            }
      ...
      function (r, i) {
        S.fn[r] = function (e, t) {
          ...
          return (
            ...
            this.length > 1 && (H[r] || S.uniqueSort(n), L.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      },
      ...
      if (
        ...
        try {
          n =
            (i = n) === 'true' ||
            (i !== 'false' &&
              (i === 'null' ? null : i === `${+i}` ? +i : J.test(i) ? JSON.parse(i) : i));
        } catch (e) {}
        Q.set(e, t, n);
      } else n = void 0;
    return n;
  ...
  function se(e, t, n, r) {
    ...
    let c = e.nodeType && (S.cssNumber[t] || (l !== 'px' && +u)) && te.exec(S.css(e, t));
    if (c && c[3] !== l) {
      (u /= 2), (l = l || c[3]), (c = +u || 1);
      while (a--)
  ...
  function le(e, t) {
    for (var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++)
      (r = e[c]).style &&
        ((n = r.style.display),
        t
          ? (n === 'none' && ((l[c] = Y.get(r, 'display') || null), l[c] || (r.style.display = '')),
            r.style.display === '' &&
              ae(r) &&
              (l[c] =
                ((u = a = o = void 0),
  ...
  function ke(e, t, n, r, i, o) {
    ...
    let s;
    if (typeof t === 'object') {
      for (s in (typeof n !== 'string' && ((r = r || n), (n = void 0)), t)) ke(e, s, n, r, t[s], o);
      return e;
    }
    if (
      (r == null && i == null
        ...
        for (a = ve(c), r = 0, i = (o = ve(e)).length; r < i; r++)
          (s = o[r]),
            ...
            (l = u.nodeName.toLowerCase()) === 'input' && pe.test(s.type)
              ? (u.checked = s.checked)
              : (l !== 'input' && l !== 'textarea') || (u.defaultValue = s.defaultValue);
      if (t)
  ...
  function Ze(e, t, n) {
    ...
    return (
      ((!y.boxSizingReliable() && i) ||
        ...
        ((i = S.css(e, 'boxSizing', !1, r) === 'border-box'), (o = s in e) && (a = e[s])),
    ...
    style(e, t, n, r) {
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        (o = typeof n) === 'string' &&
          ...
          n != null &&
            n == n &&
            (o !== 'number' || u || (n += (i && i[3]) || (S.cssNumber[s] ? '' : 'px')),
            y.clearCloneStyle || n !== '' || t.indexOf('background') !== 0 || (l[t] = 'inherit'),
    ...
    ((et.propHooks = {
      _default: {
        ...
        set(e) {
          S.fx.step[e.prop]
            ? S.fx.step[e.prop](e)
            : e.elem.nodeType !== 1 || (!S.cssHooks[e.prop] && e.elem.style[Xe(e.prop)] == null)
            ? (e.elem[e.prop] = e.now)
  ...
  S.fn.extend({
    ...
    S.extend({
      prop(e, t, n) {
        ...
        if (o !== 3 && o !== 8 && o !== 2)
          return (
            (o === 1 && S.isXMLDoc(e)) || ((t = S.propFix[t] || t), (i = S.propHooks[t])),
            void 0 !== n
              ? i && 'set' in i && void 0 !== (r = i.set(e, n, t))
                ? r
                : (e[t] = n)
    ...
    S.fn.extend({
      ...
      hasClass(e) {
        ...
        let r = 0;
        t = ` ${e} `;
        while ((n = this[r++])) if (n.nodeType === 1 && ` ${vt(yt(n))} `.indexOf(t) > -1) return !0;
        return !1;
      },
    });
  const xt = /\r/g;
    ...
    trigger(e, t, n, r) {
      ...
      if (
        ...
        n.nodeType !== 3 &&
          ...
          (u = d.indexOf(':') < 0 && `on${d}`),
          ((e = e[S.expando] ? e : new S.Event(d, typeof e === 'object' && e)).isTrigger = r
            ? 2
            : 3),
          (e.namespace = h.join('.')),
  ...
  function Dt(n, e, r, i) {
    ...
    if (Array.isArray(e))
      S.each(e, function (e, t) {
        r || St.test(n)
          ? i(n, t)
          : Dt(`${n}[${typeof t === 'object' && t != null ? e : ''}]`, t, r, i);
      });
      ...
      ajax(e, t) {
        ...
        var T = {
          ...
          setRequestHeader(e, t) {
            return (
              h == null && ((e = s[e.toLowerCase()] = s[e.toLowerCase()] || e), (a[e] = t)), this
            );
          },
          overrideMimeType(e) {
        ...
        if (
          ...
          return T;
        for (i in ((g = S.event && v.global) && S.active++ == 0 && S.event.trigger('ajaxStart'),
        ...
        v.hasContent
          ? v.data &&
            v.processData &&
            (v.contentType || '').indexOf('application/x-www-form-urlencoded') === 0 &&
                ...
                o &&
                  ...
                  e === 'abort'
                    ...
                    : t(
                        ...
                        r.statusText,
                        (r.responseType || 'text') !== 'text' || typeof r.responseText !== 'string'
                          ? { binary: r.response }
                          : { text: r.responseText },
    ...
    S.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function (t, i) {
      ...
      S.fn[t] = function (e) {
        return $(
          ...
          function (e, t, n) {
            let r;
            if ((x(e) ? (r = e) : e.nodeType === 9 && (r = e.defaultView), void 0 === n))
              return r ? r[i] : e[t];
